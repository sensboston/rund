It's a pretty small utility to run Windows console app hidden. You may use it, for example, for https://github.com/sealemar/BingRewards because standard pythonw.exe has some issues.
